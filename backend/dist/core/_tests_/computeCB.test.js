...
const computeCB_1 = require("../application/computeCB");
describe('computeCB', () => {
    test('returns zeros for invalid fuel', () => {
        const r = (0, computeCB_1.computeCB)(89.3368, 91.0, 0);
    ...
    test('R001 calculation matches manual digits (seed data)', () => {
        ...
        const { energyMJ, cbGrams, cbTonnes } = (0, computeCB_1.computeCB)(89.3368, 91.0, 5000);
        // energy = 5000 * 41000 = 205000000
        expect(energyMJ).toBe(5000 * computeCB_1.ENERGY_PER_TONNE_MJ);
    ...
    test('positive CB example (R002 seed)', () => {
        ...
        const { cbTonnes } = (0, computeCB_1.computeCB)(89.3368, 88.0, 4800);
    ...
    test('handles non-finite input gracefully', () => {
        // @ts-ignore
        const r = (0, computeCB_1.computeCB)(NaN, 90, 1000);
        expect(r.cbTonnes).toBe(0);
    });
});
